<?php
//echo "bout to dump<br>";
//var_dump($mySqlGridOptions);
//echo "<br>done<br>";
//$thePath = 'vendor/tommytest/tommytest/src/';
//require $thePath . "mysqlgrid.php";

namespace MySqlGrid;


class tommycon {
    function __construct($thevar)
    {
        echo "thevar:$thevar<br>";
    }
}
